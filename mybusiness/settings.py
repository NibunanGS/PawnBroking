...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/i073185/Work/Projects/Personal/OriginalDB.db',                      # Or path to database file if using sqlite3.
...
FORMAT_MODULE_PATH = 'mybusiness.formats'
...
SECRET_KEY = 'g4g6^hzli1)x-(p$zvay#@+0!66xh!fo&tjc7mx7!w7n%g0s5u'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    "/Users/i073185/Work/Projects/Personal/mybusiness/templates",
)
